...
## Service Contract Recovery — этап 3

Мигрированы сервисные контракты обсуждений, сообщений и уведомлений.


## Service Contract Recovery — этап 4

Мигрированы компании, документы и версии документов. Прямой доступ страницы компаний к Supabase заменён сервисным слоем.
